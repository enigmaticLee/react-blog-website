...
import { FaFacebook, FaInstagram, FaLine, FaTwitter, FaX, FaXTwitter } from 'react-icons/fa6'
            ...
            <div className='grid mb-8 lg:grid-cols-6'>
                <div className='grid grid-cols-2 gap-5 md:grid-cols-4 lg:col-span-4 '>
                    ...
                    <div>
                        ...
                        <ul className='mt-2 space-y-2'> 
                            ...
                            <li>
                                <a href="/" className='text-gray-500 transition-colors duration-300
                                hover:text-orange-500'>Profolio</a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className='mt-2 space-y-2'> 
                            ...
                            <li>
                                <a href="/" className='text-gray-500 transition-colors duration-300
                                hover:text-orange-500'>Brohure</a>
                            </li>
                            <li>
                                <a href="/" className='text-gray-500 transition-colors duration-300
                ...
                <div className='md:max-w-md lg:col-span-2 lg:mt-0 mb-5'>
                        ...
                        <form className='mt-4 flex flex-col md:flex-row'>
                            ...
                            font-medium tracing-wide text-white transition duration-200 rounded shadow-md
                            hover:bg-orange-500 focus:outline-none border'>
                                Subscribe
                            </button>
                        </form>
                        <p className='mt-4 text-sm text-gray-500'>
                            If you need to style an element based on the descendants of a parent element, you can 
                            mark the parent with the group class and use the group-has-* modifier to style the target element.
                        </p>
                </div>
            </div>
            ...
            <div className='flex flex-col justify-between pt-5 pb-10 border-t border-gray-800 sm:flex-row'>
                ...
                <div className='flex items-center mt-4 space-x-4 sm:mt-0'>
                    <a href="" className='text-gray-500 transition-all duration-300
                     hover:text-orange-500'><FaFacebookSquare className='h-6 w-6'/></a>
                     <a href="" className='text-gray-500 transition-all duration-300
                    hover:text-orange-500'><FaInstagram className='h-6 w-6'/></a>
                    <a href="" className='text-gray-500 transition-all duration-300
                     hover:text-orange-500'><FaLine className='h-6 w-6'/></a>
                    <a href="" className='text-gray-500 transition-all duration-300
                     hover:text-orange-500'><FaXTwitter className='h-6 w-6'/></a>
